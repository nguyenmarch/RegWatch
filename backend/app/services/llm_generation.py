...
async def generate_phase3_html(task, mode: str, old_doc: str, refinement_prompt: str = None) -> str:
    """
...
async def generate_phase3_html_group(tasks: list, mode: str, old_doc: str, refinement_prompt: str = None) -> str:
    """
