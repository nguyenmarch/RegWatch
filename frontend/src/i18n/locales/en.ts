const en = {
  ...
  actionPlan: {
    title: 'Action Plan',
    subtitle: 'Manage compliance action plans for alerts',
    ...
    selectAlertFirst: 'Please select an alert first',
    ...
    toast: {
      saveSucess: 'Action plan saved successfully',
      saveError: 'Failed to save action plan',
      finalizeSuccess: 'Action plan finalized successfully',
      finalizeError: 'Failed to finalize action plan',
