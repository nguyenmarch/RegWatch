const en = {
  ...
  remediation: {
    ...
    emptyDesc: 'After selecting a plan, check the tasks you need to handle, then click ✦ Generate Documents. AI will automatically group tasks affecting the same internal document and revise them in parallel.',
    ...
    noContentRefine: 'Content not yet generated. Click ✨ to refine or regenerate.',
