const vi = {
  ...
  actionPlan: {
    ...
    subtitle: 'Quản lý kế hoạch hành động tuân thủ cho các Alert rủi ro',
    tabAlertHistory: 'Lịch sử Alert',
    tabActionPlan: 'Kế hoạch Hành động',
    tabLLMRecommend: 'Gợi ý từ LLM',
    tabKnowledgeBase: 'Kho Tài liệu',
    alertHistory: 'Tất cả Alert',
    issuedDate: 'Ngày phát hành',
    dueDate: 'Hạn cuối',
    noAlerts: 'Không tìm thấy alert nào',
    selectAlertFirst: 'Vui lòng chọn một alert trước',
    ...
    toast: {
      saveSucess: 'Đã lưu kế hoạch hành động',
      saveError: 'Không thể lưu kế hoạch hành động',
      finalizeSuccess: 'Đã chốt kế hoạch hành động',
      finalizeError: 'Không thể chốt kế hoạch hành động',
