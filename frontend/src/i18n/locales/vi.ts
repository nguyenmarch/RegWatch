const vi = {
  ...
  analyses: {
    ...
    subtitle: 'Mỗi tài liệu đã tải lên là một analysis cha, bên trong có dashboard riêng cho các finding con.',
    refresh: 'Làm mới',
    loading: 'Đang tải phân tích...',
    pendingNotice: '{{count}} tài liệu đang chờ sinh phân tích. Hệ thống sẽ tự thử lại khi có tài nguyên.',
    parentRuns: 'Analysis cha',
    childFindings: 'Finding con',
    openItems: 'Mục đang mở',
    tabs: {
      history: 'History',
      findings: 'Tất cả finding',
    },
    stats: {
      urgent: 'Khẩn cấp',
      review: 'Cần rà soát',
    ...
    emptyHistoryHint: 'Tải tài liệu trong Kho Tri thức. Card analysis cha sẽ xuất hiện sau khi xử lý xong.',
    emptyFindingsTitle: 'Chưa có finding nào.',
    emptyFindingsHint: 'Finding được sinh tự động từ các tài liệu đã xử lý.',
    emptyFilterTitle: 'Không có analysis nào khớp bộ lọc này.',
    runDashboard: 'Dashboard tài liệu',
    runNotFound: 'Không tìm thấy analysis cha.',
